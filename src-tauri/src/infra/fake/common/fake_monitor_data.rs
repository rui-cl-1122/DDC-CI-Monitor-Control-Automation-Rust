...
pub fn display1_basic_edid() -> PlatformBasicEdid {
    PlatformBasicEdid {
...
pub fn display2_basic_edid() -> PlatformBasicEdid {
    PlatformBasicEdid {
...
pub fn display1_edid_monitor() -> PlatformEdidMonitor {
    PlatformEdidMonitor {
        logical_name: DISPLAY1_LOGICAL_NAME.to_string(),
        edid: display1_basic_edid(),
    }
}

pub fn display2_edid_monitor() -> PlatformEdidMonitor {
    PlatformEdidMonitor {
        logical_name: DISPLAY2_LOGICAL_NAME.to_string(),
        edid: display2_basic_edid(),
    }
}